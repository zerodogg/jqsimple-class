...
minify: minifyPrep
	...
	perl -pi -e 's/_buildConstructor/_B/g; s/destructors/_d/g; s/_meta/_m/g; s/_strictArray/_s/g; s/_resolveInheritance/_R/g; s/virtual:t/v:t/g; s/\.virtual/\.v/g; s/objs:/o:/g; s/\.objs/\.o/g; s/objs/_o/g; s/_extendClass/_e/g; s/obj/O/g;' jqsimple-class.min.js
clean:
	rm -f *.min.js
	rm -f *~
